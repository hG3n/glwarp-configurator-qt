...
/**
 * @brief The Path class holds a vector and acts as a more fail save way of handling paths.
 *
 * This was introduced way before a Qt UI had been planned.
 * Using QDir instead might make sense.
 */
class Path {
